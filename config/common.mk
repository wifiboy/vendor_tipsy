...
#    tipsyFileManager removed until updated
...
# Set all versions
TIPSY_VERSION := tipsy-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(TIPSY_BUILD_TYPE)$(TIPSY_POSTFIX)
